...
{
	public DeadAssignmentEliminator( final Singletons.Global g ) {}
	...
	protected void internalTransform(final Body b, final String phaseName, final Map<String, String> options)
	{
		...
		for (Iterator<Unit> it = units.iterator(); it.hasNext(); ) {
			...
			// chw: we have a separate Eliminator for NopStmt. Hence, this eliminator should not remove NopStmts.
